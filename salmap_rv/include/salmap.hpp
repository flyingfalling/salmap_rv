...
namespace salmap_rv
{
  ...
  public:
    ...
    void set_filt_input_param( FeatFilter& f, const std::string& argstr ) ;
  
    void set_filt_input_param( FeatFilter& f,  const std::vector<std::string>& argvec );
  
    template <typename T>
    void set_filt_input_params( FeatFilter& f, const T& t );

    
    template <typename T, typename T2, typename ...Rest>
    void set_filt_input_params( FeatFilter& f, const T& t, const T2& t2, Rest... rest);
